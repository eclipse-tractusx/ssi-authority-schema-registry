...
public class RegistryRepositories(RegistryContext dbContext) : IRegistryRepositories
{
    private static readonly ImmutableDictionary<Type, Func<RegistryContext, object>> Types = new Dictionary<Type, Func<RegistryContext, object>> {
