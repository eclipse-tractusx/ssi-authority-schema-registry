...
public static class RouteHandlerBuilderExtensions
{
    ...
    public static RouteHandlerBuilder WithDefaultResponses(this RouteHandlerBuilder builder) =>
        builder
            .Produces(StatusCodes.Status401Unauthorized, typeof(ErrorResponse), contentType: Constants.JsonContentType)
            .Produces(StatusCodes.Status500InternalServerError, typeof(ErrorResponse), Constants.JsonContentType);
}
